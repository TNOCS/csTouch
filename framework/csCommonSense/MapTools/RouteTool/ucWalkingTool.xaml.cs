...
{
    public partial class ucWalkingTool
    {
        ...
        public static readonly DependencyProperty PositionProperty =
            DependencyProperty.Register("Position", typeof(MapPoint), typeof(ucWalkingTool),
        ...
        public static readonly DependencyProperty GrphProperty =
            DependencyProperty.Register("Grph", typeof(Graphic), typeof(ucWalkingTool), new UIPropertyMetadata(null));
        ...
        public static readonly DependencyProperty LatLonProperty =
            DependencyProperty.Register("LatLon", typeof(string), typeof(ucWalkingTool), new UIPropertyMetadata(""));


        public static readonly DependencyProperty CanBeDraggedProperty =
            DependencyProperty.Register("CanBeDragged", typeof(bool), typeof(ucWalkingTool),
        ...
        private void UcPlacemarkLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (DataContext is DataBinding)
            {
                ...
                this.measure = db.Attributes["measure"] as Route;
                state = db.Attributes["state"].ToString();
                measure.PropertyChanged += _measure_PropertyChanged;
        ...
        public static readonly DependencyProperty MenuProperty =
            DependencyProperty.Register("Menu", typeof(bool), typeof(ucWalkingTool), new UIPropertyMetadata(false));
        ...
        {
            if (measure == null) _firstMove = true;
            if (CanBeDragged && measure == null)
            {
                measure = new Route() { Layer = this.layer, Mode = "walking" };
                ...
                System.Windows.Point p2 = e.Position;
                ...
                measure.Init(layer, mpStart, mpFinish, this.Resources);
            ...
            else
            {
                ...
                if (measure != null)
                {
                    System.Windows.Point pos = e.Position;
        ...
        private void mmiZoom_Tap(object sender, RoutedEventArgs e) {
            ...
            AppStateSettings.Instance.ViewDef.MapControl.ZoomToResolution(1,
                state == "start" ? measure.Start.Mp : measure.Finish.Mp);
        }
