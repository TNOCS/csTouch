...
namespace WPFSpark
{
    ...
    public class FluidWrapPanel : Panel
    {
        ...
        private static TimeSpan FIRST_TIME_ANIMATION_DURATION = TimeSpan.FromMilliseconds(120);
        ...
        public List<UIElement> fluidElements = null;
        ...
        public static readonly DependencyProperty DragScaleProperty =
            DependencyProperty.Register("DragScale", typeof(double), typeof(FluidWrapPanel),
                new FrameworkPropertyMetadata(DRAG_SCALE_DEFAULT, OnDragScaleChanged));
