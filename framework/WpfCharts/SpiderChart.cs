...
namespace WpfCharts
{
    ...
    public class SpiderChart : Control
    {
        ...
        public static readonly DependencyProperty HoleRadiusProperty =
            DependencyProperty.Register("HoleRadius", typeof(double), typeof(SpiderChart),
                new FrameworkPropertyMetadata((double)0, OnHoleRadiusChanged));

        /// <summary>
        /// Gets or sets the HoleRadius property. This dependency property 
        /// indicates the radius of the hole inside the spider chart (default is 0, or no hole).
        /// </summary>
        ...
        /// <summary>
        /// ChartBackgroundColor Dependency Property
        /// </summary>
        public static readonly DependencyProperty ChartBackgroundColorProperty =
            DependencyProperty.Register("ChartBackgroundColor", typeof(Color), typeof(SpiderChart),
                new FrameworkPropertyMetadata(Colors.Transparent, OnChartBackgroundColorChanged));

        /// <summary>
        /// Gets or sets the ChartBackgroundColor property. This dependency property 
        /// indicates the background color used for the chart.
        /// </summary>
        ...
        /// <summary>
        /// Handles changes to the ChartBackgroundColor property.
        /// </summary>
        private static void OnChartBackgroundColorChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var target = (SpiderChart)d;
            var oldChartBackgroundColor = (Color)e.OldValue;
            var newChartBackgroundColor = target.ChartBackgroundColor;
            target.OnChartBackgroundColorChanged(oldChartBackgroundColor, newChartBackgroundColor);
        }

        /// <summary>
        /// Provides derived classes an opportunity to handle changes to the ChartBackgroundColor property.
        /// </summary>
        protected virtual void OnChartBackgroundColorChanged(Color oldChartBackgroundColor, Color newChartBackgroundColor)
        {
        }
        ...
        public static readonly DependencyProperty LegendBackgroundColorProperty =
            DependencyProperty.Register("LegendBackgroundColor", typeof(Color), typeof(SpiderChart),
                new FrameworkPropertyMetadata(Colors.Wheat, OnLegendBackgroundColorChanged));
        ...
        public static readonly DependencyProperty IsInteractiveProperty =
            DependencyProperty.Register("IsInteractive", typeof(bool), typeof(SpiderChart),
        ...
        private static void OnIsInteractiveChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            //var spiderChartPanel = FindVisualChildren<SpiderChartPanel>(target).FirstOrDefault();
            //if (spiderChartPanel == null) return;
            //spiderChartPanel.ValuesChanged += (sender, args) => target.OnValuesChanged(args);
        }
        ...
        /// <summary>
        /// Find all visual children
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="depObj"></param>
        /// <returns></returns>
        /// <see cref="http://stackoverflow.com/questions/974598/find-all-controls-in-wpf-window-by-type"/>
